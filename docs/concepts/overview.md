...
The Pine Billing SDK is a single Rust core (`pine-billing-core`) projected via UniFFI into Kotlin, Swift, Python, Node.js, and C. It is a **payment transaction client** that talks to Pinelabs PoS terminals over one of several transports.
